<%@ Register TagPrefix="inc" TagName="header" Src="IncFiles/OnlineApp_HeaderPanel.ascx" %>
<%@ Register TagPrefix="inc" TagName="Footer" Src="IncFiles/OnlineApp_FooterPanel.ascx" %>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OnlineApp_Home.aspx.vb" Inherits="SMCOnline.OnlineApp_Home" %>
...
<head>
    ...
    <link href="static/chatbot-widget.css?v=3" rel="stylesheet" type="text/css">
    <%  %>
    ...
    <script type="text/javascript" language="javascript">
        window.SMC_CHAT_FRAME_URLS = [
            "/widget-embed",
            "http://127.0.0.1:8086/widget-embed",
            "http://localhost:8086/widget-embed"
        ];
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" class="TableBorder">
            <tr>
                <td colspan="2" valign="top" height="116">
                    <inc:header ID="incHdr" runat="server"></inc:header>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr height="30" align="center">
                <td colspan="2" bgcolor="#ffffff">
                    <inc:Footer ID="incFtr" runat="server"></inc:Footer>
                </td>
            </tr>
        <%-- </table>--%>
        ...
        <div id="chatbot" class="smc-chatbot-widget chat-hidden">
            <div class="chat-header">
                <div class="chat-brand">
                    <img src="static/logo.png" alt="Stella Maris College logo" class="chat-logo" />
